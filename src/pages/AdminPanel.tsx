...
const AdminPanel = () => {
  ...
  const tabs = [
    ...
    { id: "service-projects" as AdminTab, label: "Service Projects", icon: Briefcase, visible: permissions.can_view_service_projects },
    { id: "appointments" as AdminTab, label: "Appointments", icon: Calendar, visible: permissions.can_view_appointments },
    { id: "invoices" as AdminTab, label: "Invoices", icon: FileText, visible: permissions.can_view_invoices },
    { id: "technicians" as AdminTab, label: "Technicians", icon: Wrench, visible: permissions.can_view_technicians },
    ...
    { id: "bot" as AdminTab, label: "Bot Settings", icon: Bot, visible: permissions.can_view_bot_settings },
    { id: "smart-search" as AdminTab, label: "Smart Search", icon: Search, visible: permissions.can_use_smart_search },
    { id: "quick-actions" as AdminTab, label: "Quick Actions", icon: Sparkles, visible: permissions.can_use_quick_actions },
    { id: "admin-notes" as AdminTab, label: "Notes", icon: StickyNote, visible: permissions.can_use_notes },
